...
namespace LookAndPlayForm
{
    public partial class CalibrationResultPanel : Control
    {
        ...
        private void ExtractCalibrationPoints()
        {
            ...
            foreach (var plotItem in _calibrationDataEyeX)
            {
                //Como el dato almacenado de la calibracion es una lista plana donde no hay diferencia entre los puntos de calibracion posicionados en diferentes lugares, se hace este proceso de buscar diferentes puntos de calibracion
